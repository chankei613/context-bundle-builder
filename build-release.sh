#!/bin/bash
# Context Bundle Builder release build: wails build → codesign → notarize → staple → zip
# mcp-server-manager/execution-ledgerのbuild-release.shの構成を踏襲。
...
APP_NAME="context-bundle-builder"
...
echo "==> Building Context Bundle Builder v${VERSION}..."
